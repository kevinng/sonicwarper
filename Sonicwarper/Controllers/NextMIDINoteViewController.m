...
#import "NextMIDINoteViewController.h"

@interface NextMIDINoteViewController()
...
@implementation NextMIDINoteViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
  if (indexPath.row == 0) {
    // On is selected.
    self.behavior.midiToggled = NO;
  } else {
    // Off is selected.
    self.behavior.midiToggled = YES;
  }
